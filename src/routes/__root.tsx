...
import { AutoTranslateProvider } from "@/components/site/AutoTranslate";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Scheme Sathi AI — Discover Government Schemes You Deserve",
      },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/320fc8e4-ab5f-4c9e-9c01-e116637968bb",
      },
      {
        name: "twitter:image",
        content:
