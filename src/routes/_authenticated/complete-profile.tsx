      ...
      <form onSubmit={onSubmit} className="card-elevated space-y-5 p-6 md:p-8">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Text
            ...
            type="tel"
          />
          <Text label="Age" value={form.age} onChange={(v) => set("age", v)} type="number" />
          <Select
            label="Gender"
            value={form.gender}
          ...
          <Select
            ...
            options={OCCUPATIONS.map((o) => o.value)}
            labels={Object.fromEntries(OCCUPATIONS.map((o) => [o.value, o.label]))}
          />
          <Text
            label="Annual Income (₹)"
