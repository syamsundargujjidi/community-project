      ...
      <div className="perspective-1000 relative w-full max-w-md">
        ...
        >
          <FormFace
            hidden={flipped}
            title="Welcome back"
            subtitle="Sign in to access your saved schemes"
          >
          ...
          <FormFace
            ...
            subtitle="Just 6+ characters — nothing fancy"
          >
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 30px 80px -30px oklch(0.4 0.14 220 / 0.5), 0 10px 30px -15px oklch(0.3 0.08 220 / 0.3)",
      }}
    >
