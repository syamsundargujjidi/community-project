    ...
    <article className="card-elevated flex flex-col p-6">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-2">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-1 rounded-xl border border-input bg-secondary/50 px-3 py-2.5 text-xs font-semibold text-muted-foreground hover:bg-secondary hover:text-foreground transition shrink-0"
        >
